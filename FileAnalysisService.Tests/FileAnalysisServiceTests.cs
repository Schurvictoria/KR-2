...
{
    [Fact(DisplayName = "GetFileStreamAsync requests the correct URL and returns the stream")]
    ...
    [Fact(DisplayName = "GetFileStreamAsync throws on error status")]
...
{
    [Fact(DisplayName = "GenerateCloudAsync throws on unsuccessful status")]
...
{
    [Fact(DisplayName = "Analyze returns OK with DTO")]
    ...
    [Fact(DisplayName = "GetResult returns NotFound if no result")]
    ...
    [Fact(DisplayName = "GetResult returns OK with DTO")]
    ...
    [Fact(DisplayName = "GetCloud returns FileContentResult if file exists")]
    ...
    [Fact(DisplayName = "GetCloud returns NotFound if file does not exist")]
